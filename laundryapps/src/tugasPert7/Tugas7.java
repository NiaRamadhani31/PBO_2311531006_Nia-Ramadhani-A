...
public class Tugas7 extends JFrame {
	...
	public Tugas7() {
		...
		lblMasukkanData.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		lblHasilCek.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		lblCekDataKe.setFont(new Font("Tahoma", Font.PLAIN, 16));
